...
htmlFiles.forEach(filename => {
  ...
  content = content.replace(
    /<!-- DYNAMIC:INTRO -->[\s\S]*?<!-- \/DYNAMIC:INTRO -->/,
    `<!-- DYNAMIC:INTRO -->\n      ${newIntro}\n<!-- /DYNAMIC:INTRO -->`
  );

  // Rotate last verified date
  content = content.replace(
    /<!-- DYNAMIC:LAST-VERIFIED -->[\s\S]*?<!-- \/DYNAMIC:LAST-VERIFIED -->/,
  ...
  // Rotate lead image
  content = content.replace(
    /<!-- DYNAMIC:LEAD-IMAGE -->[\s\S]*?<!-- \/DYNAMIC:LEAD-IMAGE -->/,
  ...
  content = content.replace(
    /<!-- DYNAMIC:ENGAGEMENT -->[\s\S]*?<!-- \/DYNAMIC:ENGAGEMENT -->/,
